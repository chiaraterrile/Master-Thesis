...
//FILE *choosen_parameter_file = fopen("choosen_param.txt", "a");
	...
	// battery drop is between 2 and 10
	...
	simInfo.cyclesToDestination = simInfo.cyclesToDestinationPlanned;
	simInfo.batteryDrop = randomInteger(2, 10); ////SAFE=10
	simInfo.batteryRise = 100;
	// The robot charging routine starts if batteryLevel is below 300
	// If batteryDrop is 10 and cyclesToChargingPlanned is greater than 30,
	// the robot will not be able to reach the charging station
	simInfo.cyclesToChargingPlanned = 60;
